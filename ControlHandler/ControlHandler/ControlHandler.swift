...
open class EPControls: NSObject,UIImagePickerControllerDelegate,MFMailComposeViewControllerDelegate,UINavigationControllerDelegate,UIAlertViewDelegate{
    ...
    ///Shared instance
    open static let sharedInstance = EPControls()
